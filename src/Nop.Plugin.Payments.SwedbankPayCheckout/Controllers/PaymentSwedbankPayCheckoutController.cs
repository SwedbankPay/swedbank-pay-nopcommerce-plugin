...
using Nop.Plugin.Payments.SwedbankPayCheckout.Models;
...
namespace Nop.Plugin.Payments.SwedbankPayCheckout.Controllers
{
    public class PaymentSwedbankPayCheckoutController : BasePaymentController
    {
        #region Fields
        ...
        public PaymentSwedbankPayCheckoutController(IGenericAttributeService genericAttributeService,
